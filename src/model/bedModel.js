...
export function buildBedAssembly() {
  ...
  ids.rails.push(
    addPart({
      ...
      info: makeInfo(
        ...
        '101 x 3.2 x 3.2 cm',
        'https://www.leroymerlin.pt/search?q=ripa%20madeira%202400x32x32',
  ...
  for (let i = 0; i < slatCount; i += 1) {
    ...
    const slatId = addPart({
      ...
      info: makeInfo(
        ...
        '62 x 4.8 x 1.3 cm',
        'https://www.leroymerlin.pt/search?q=ripa%20madeira%202400x48x13',
  ...
  addPart({
    ...
    info: makeInfo(
      ...
      '104.6 x 6 x 1.8 cm',
      'https://www.leroymerlin.pt/search?q=tabua%20madeira%201250x200x18',
  ...
  function addLeg(cornerName, px, pz) {
    const legId = addPart({
      ...
      info: makeInfo(
        ...
        '16 x 5.6 x 5.6 cm',
        'https://www.leroymerlin.pt/search?q=ripa%20madeira%20900x56x56',
